    ...
    $('#data_table').DataTable({
        ...
        columnDefs: [
            ...
            { width: 150, targets: 5, className: "text-center", render: function(data){
                return `<a href="/concursos/` + data + `" class="btn btn-primary btn-sm" role="button"><i class="fas fa-eye"></i></a>
                        <a href="/concursos/` + data + `/editar" class="btn btn-success btn-sm" role="button"><i class="fas fa-pen"></i></a>
