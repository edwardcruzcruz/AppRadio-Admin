$('#data_table').DataTable({
    ...
    columnDefs: [
        ...
        { width: 150, className: "text-center", targets: 7, render: function(data){
            return `<a href="/usuarios/` + data + `" class="btn btn-primary btn-sm" role="button"><i class="fas fa-eye"></i></a>
                    <a href="/usuarios/` + data + `/editar" class="btn btn-success btn-sm" role="button"><i class="fas fa-pen"></i></a>
